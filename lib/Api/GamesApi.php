...
class GamesApi
{
    ...
    public function getGameRequest($game_id, string $contentType = self::contentTypes['getGame'][0])
    {
        ...
        $resourcePath = '/v1/cf/games/{gameId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getVersionTypesRequest($game_id, string $contentType = self::contentTypes['getVersionTypes'][0])
    {
        ...
        $resourcePath = '/v1/cf/games/{gameId}/version-types';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getVersionsRequest($game_id, string $contentType = self::contentTypes['getVersions'][0])
    {
        ...
        $resourcePath = '/v1/cf/games/{gameId}/versions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getVersionsV2Request($game_id, string $contentType = self::contentTypes['getVersionsV2'][0])
    {
        ...
        $resourcePath = '/v2/cf/games/{gameId}/versions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
