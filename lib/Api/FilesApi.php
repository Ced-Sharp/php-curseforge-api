...
class FilesApi
{
    ...
    public function getModFileRequest($mod_id, $file_id, string $contentType = self::contentTypes['getModFile'][0])
    {
        ...
        $resourcePath = '/v1/cf/mods/{modId}/files/{fileId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getModFileChangelogRequest($mod_id, $file_id, string $contentType = self::contentTypes['getModFileChangelog'][0])
    {
        ...
        $resourcePath = '/v1/cf/mods/{modId}/files/{fileId}/changelog';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getModFileDownloadURLRequest($mod_id, $file_id, string $contentType = self::contentTypes['getModFileDownloadURL'][0])
    {
        ...
        $resourcePath = '/v1/cf/mods/{modId}/files/{fileId}/download-url';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getModFilesRequest($mod_id, $game_version = null, $mod_loader_type = null, $game_version_type_id = null, $index = null, $page_size = null, string $contentType = self::contentTypes['getModFiles'][0])
    {
        ...
        $resourcePath = '/v1/cf/mods/{modId}/files';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
